...
import ShareDialogBox from "../shareDailogBox/ShareDialogBox";
...
export default function Nav() {
  ...
  return (
    <>
      {/* Navbar  */}
      <Navbar
        className="sticky inset-0 z-20 h-max max-w-full border-none rounded-none py-1 px-3 lg:px-8 lg:py-2"
      ...
      >
        ...
        <div className="flex items-center justify-between text-blue-gray-900">
          ...
          <Link to={"/"}>
            <Typography
              as="a"
              className="mr-4 cursor-pointer  text-xl font-bold flex gap-2 items-center"
              style={{ color: mode === "dark" ? "white" : "white" }}
            >
              {/* Logo Image  */}
              <img
